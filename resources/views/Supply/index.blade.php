                            ...
                            <div class="card p-4">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <a href="{{ route('addSupply') }}"
                                            class="btn btn-primary btn-sm mb-3 font-weight-bold my-auto"><i
                                                class="ti-plus mr-2"></i>Tambah Persediaan Barang</a>
                                                @endif
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped" width="10px">
                                            ...
                                            <tbody>
                                                @if ($supply[0] == null)
                                                    <tr>
                                                        <td colspan="12" class="text-center">Tidak ada data persediaan
                                                            barang</td>
                                                    </tr>
                                                @else
