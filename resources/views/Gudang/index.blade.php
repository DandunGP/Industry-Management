      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            <h3 class="font-weight-bold">Gudang</h3>
          </div>
                    ...
                    @foreach ($warehouse as $wh)
                      <tr>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal" onclick="handleDelete({{ $wh->id }})"><i class="ti-trash"></i></button>
                        </td>
                      </tr>
                    @endforeach
                  @endif
...
<script>
  function handleDelete(id){
    document.getElementById('formDelete').action = `warehouse/delete/${id}`
  }
</script>
@endsection