                            ...
                            <div class="card p-4">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between mb-3">
                                        <a href="{{ route('addIncoming') }}"
                                            class="btn btn-primary btn-sm mb-3 font-weight-bold my-auto"><i
                                                class="ti-plus mr-2"></i>Tambah Barang Masuk</a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped" width="10px">
                                            ...
                                            <tbody>
                                                @if ($incoming[0] == null)
                                                    <tr>
                                                        <td colspan="11" class="text-center">Tidak ada data barang masuk
                                                        </td>
                                                    </tr>
                                                @else
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-3">
                                            <h6>Print Laporan Barang Masuk</h6>
                                        </div>
                                    </div>
                                    <form action="{{ route('printIncoming') }}" method="post">
                                        @csrf
